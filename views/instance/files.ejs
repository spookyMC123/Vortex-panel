...
<main id="content">
   ...
   <div class="bg-transparent">
      <div class="sm:flex sm:items-center px-8 pt-4">
         ...
         <div class="mt-4 sm:ml-16 sm:mt-0 flex space-x-4">
            <div class="relative">
               <input type="text" id="searchInput" placeholder="Search files..." class="px-4 py-2.5 bg-white/5 border border-white/10 shadow-lg focus:scale-105 transition rounded-xl text-white placeholder-neutral-500 focus:outline-none focus:border-neutral-600 focus:ring-1 focus:ring-neutral-600 w-64">
               <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-4 h-4 absolute right-3 top-3 text-neutral-400">
                  <path fill-rule="evenodd" d="M9 3.5a5.5 5.5 0 100 11 5.5 5.5 0 000-11zM2 9a7 7 0 1112.452 4.391l3.328 3.329a.75.75 0 11-1.06 1.06l-3.329-3.328A7 7 0 012 9z" clip-rule="evenodd" />
               </svg>
            </div>
            <button id="uploadBtn" class="flex items-center rounded-xl <%= theme['button-color'] %> px-4 py-2.5 text-center text-sm font-medium shadow-lg transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
   ...
   <div class="px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between mb-4">
         ...
         <p id="diskUsage" class="text-sm text-neutral-400 bg-white/5 px-3 py-1 rounded-lg">Loading...</p>
      </div>
      
      <div class="overflow-hidden border border-white/5 shadow rounded-xl">
         <table class="min-w-full divide-y divide-white/5">
            <thead class="bg-white/5">
               <tr>
                  ...
                  <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-neutral-300 uppercase tracking-wider"></th>
               </tr>
            </thead>
                  ...
                  <tr class="hover:bg-white/2.5 transition">
                     ...
                     <td class="px-6 py-4 whitespace-nowrap">
                        <a href="/instance/<%= req.params.id %>/files?path=<%= currentPath %><%= encodeURIComponent(directory.name) %>" class="flex items-center group">
                           ...
                           <span class="text-sm font-medium text-white group-hover:text-blue-400 transition"><%= directory.name %></span>
                        </a>
                     </td>
                  ...
                  <tr class="hover:bg-white/2.5 transition">
                     ...
                     <td class="px-6 py-4 whitespace-nowrap">
                        <a href="/instance/<%= req.params.id %>/files/view/<%= encodeURIComponent(file.name) %><%= extension %>" class="flex items-center group">
                           ...
                           <span class="text-sm font-medium text-white group-hover:text-blue-400 transition"><%= file.name %></span>
                        </a>
                     </td>
                     <td class="px-6 py-4 whitespace-nowrap text-sm text-neutral-400">
                        <%= file.size %>
   ...
   <!-- Floating Action Bar -->
   <div id="floatingActionBar" class="fixed bottom-6 left-1/2 transform -translate-x-1/2 bg-neutral-800/90 backdrop-blur text-white py-3 px-6 rounded-xl shadow-xl border border-white/10 flex items-center space-x-6 translate-y-full transition-transform duration-300 ease-in-out">
      <span id="selectedFilesCount" class="text-sm">0 files selected</span>
      <button id="massDeleteBtn" class="flex items-center text-sm bg-red-500/90 hover:bg-red-600 text-white font-normal py-1.5 px-3 rounded-lg transition">
      ...
      <button id="massExtractBtn" class="flex items-center text-sm bg-green-500/90 hover:bg-green-600 text-white font-normal py-1.5 px-3 rounded-lg transition hidden">
         <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-4 h-4 mr-1.5">
